"""
scrape_azure.py
Scrapes the Microsoft Azure page on Quantum Computing.
"""
...
URL = "https://azure.microsoft.com/en-in/resources/cloud-computing-dictionary/what-is-quantum-computing"
...
def scrape_azure() -> list:
    try:
        response = requests.get(URL, headers=HEADERS, timeout=20)
        response.raise_for_status()
    except Exception as e:
        print(f"[Azure] Failed to fetch: {e}")
        return []
    ...
    # Azure pages often use h2/h3 headings + paragraphs
    ...
    for section in sections:
        ...
        for sibling in section.find_next_siblings():
            ...
            # Some pages also use divs with text
    ...
    print(f"[Azure] Extracted {len(entries)} chunks.")
    return entries
